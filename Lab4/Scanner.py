...
class Scanner:
    ...
    def __init__(self, filepath):
        ...
        self.pifOutput = []
        self.identifiersFA = FiniteAutomata("FAIdentifier.in")
        self.integerConstantsFA = FiniteAutomata("FAIntegerConstants.in")
    ...
    def scan(self):
        ...
        for t in tokens:
            ...
            elif self.identifiersFA.can_obtain_sequence(token): # Changed to work with FA
